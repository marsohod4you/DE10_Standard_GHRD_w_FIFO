...
module soc_system_mm_interconnect_2 (
	...
	wire   [31:0] loopback_fifo_0_csr_agent_m0_address;                                       // Loopback_FIFO_0_csr_agent:m0_address -> Loopback_FIFO_0_csr_translator:uav_address
	...
	wire  [106:0] loopback_fifo_0_csr_agent_rf_source_data;                                   // Loopback_FIFO_0_csr_agent:rf_source_data -> Loopback_FIFO_0_csr_agent_rsp_fifo:in_data
	...
	wire  [106:0] loopback_fifo_0_csr_agent_rsp_fifo_out_data;                                // Loopback_FIFO_0_csr_agent_rsp_fifo:out_data -> Loopback_FIFO_0_csr_agent:rf_sink_data
	...
	wire          cmd_mux_003_src_valid;                                                      // cmd_mux_003:src_valid -> Loopback_FIFO_0_csr_agent:cp_valid
	wire  [105:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> Loopback_FIFO_0_csr_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                      // Loopback_FIFO_0_csr_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> Loopback_FIFO_0_csr_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                              // cmd_mux_003:src_startofpacket -> Loopback_FIFO_0_csr_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                // cmd_mux_003:src_endofpacket -> Loopback_FIFO_0_csr_agent:cp_endofpacket
	...
	wire          loopback_fifo_0_csr_agent_rp_valid;                                         // Loopback_FIFO_0_csr_agent:rp_valid -> router_005:sink_valid
	wire  [105:0] loopback_fifo_0_csr_agent_rp_data;                                          // Loopback_FIFO_0_csr_agent:rp_data -> router_005:sink_data
	wire          loopback_fifo_0_csr_agent_rp_ready;                                         // router_005:sink_ready -> Loopback_FIFO_0_csr_agent:rp_ready
	wire          loopback_fifo_0_csr_agent_rp_startofpacket;                                 // Loopback_FIFO_0_csr_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          loopback_fifo_0_csr_agent_rp_endofpacket;                                   // Loopback_FIFO_0_csr_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          loopback_fifo_0_csr_agent_rdata_fifo_src_valid;                             // Loopback_FIFO_0_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] loopback_fifo_0_csr_agent_rdata_fifo_src_data;                              // Loopback_FIFO_0_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          loopback_fifo_0_csr_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_003:in_0_ready -> Loopback_FIFO_0_csr_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                          // avalon_st_adapter_003:out_0_valid -> Loopback_FIFO_0_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                           // avalon_st_adapter_003:out_0_data -> Loopback_FIFO_0_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                          // Loopback_FIFO_0_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                          // avalon_st_adapter_003:out_0_error -> Loopback_FIFO_0_csr_agent:rdata_fifo_sink_error
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (loopback_fifo_0_csr_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (loopback_fifo_0_csr_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (loopback_fifo_0_csr_agent_rdata_fifo_src_ready), //         .ready
